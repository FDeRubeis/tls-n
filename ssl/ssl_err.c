...
static const ERR_STRING_DATA SSL_str_functs[] = {
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_ADVANCE_HASH_CHAIN_FROM_CURR_NODE, 0),
     "advance_hash_chain_from_curr_node"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_BYTES_TO_CIPHER_LIST, 0),
     "bytes_to_cipher_list"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_CHECK_AVAILABILITY, 0), "check_availability"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_CHECK_SUITEB_CIPHER_LIST, 0),
     "check_suiteb_cipher_list"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_COMPUTE_WRITE_HASH_CHAIN_INDEX, 0),
     "compute_write_hash_chain_index"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_FIND_SENSITIVE_CHUNKS, 0),
     "find_sensitive_chunks"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_GENERATE_EVIDENCE_HASH, 0),
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_PARSE_AND_CHECK_PROOF, 0),
     "parse_and_check_proof"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_PARSE_CA_NAMES, 0), "parse_ca_names"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_PARSING_EXTENSION_DATA, 0),
     "parsing_extension_data"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_PROCESS_KEY_SHARE_EXT, 0), ""},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_READ_STATE_MACHINE, 0), "read_state_machine"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_RECEIVE_ORD_VECTOR, 0), "receive_ord_vector"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_CTX_GET_CHUNK_SIZE, 0),
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_CTX_SET_CHUNK_SIZE, 0),
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_CTX_SET_SALT_SIZE, 0),
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_CTX_SET_TLSN_VERSION, 0),
     "SSL_CTX_set_tlsn_version"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_SET_CHUNK_SIZE, 0), "SSL_set_chunk_size"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_SET_NEGOTIATED, 0), "SSL_set_negotiated"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_SET_PKEY, 0), "ssl_set_pkey"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_SET_RFD, 0), "SSL_set_rfd"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_SET_SALT_SIZE, 0), "SSL_set_salt_size"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_SET_TLSN_VERSION, 0),
     "SSL_set_tlsn_version"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_START_ASYNC_JOB, 0),
     "ssl_start_async_job"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_TLSN_HIDE_SENSITIVE_CHUNKS, 0),
     "SSL_tlsn_hide_sensitive_chunks"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_TLSN_RECEIVE_EVIDENCE, 0),
     "SSL_tlsn_receive_evidence"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_TLSN_RECEIVE_RESPONSE, 0),
     "SSL_tlsn_receive_response"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_TLSN_REQUEST_EVIDENCE, 0),
     "SSL_tlsn_request_evidence"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_TLSN_VERIFY_INTERNAL, 0),
     "SSL_tlsn_verify_internal"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_TLS_GET_PROOF_STRING, 0),
     "SSL_tls_get_proof_string"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_TLS_PROOF_HIDE_SENSITIVE_CHUNKS, 0),
     "SSL_tls_proof_hide_sensitive_chunks"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_TLS_PROOF_REQUEST_EVIDENCE, 0),
     "SSL_tls_proof_request_evidence"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_TLS_PROOF_REQUEST_PROOF, 0),
     "SSL_tls_proof_request_proof"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_TLS_PROOF_VERIFY_INTERNAL, 0),
     "SSL_tls_proof_verify_internal"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLSN_HANDLE_MESSAGE, 0),
     "tlsn_handle_message"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLSN_HANDLE_MESSAGE_RESPONSE, 0),
     "tlsn_handle_message_response"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PROCESS_SKE_SRP, 0),
     "tls_process_ske_srp"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PROOF_HANDLE_MESSAGE, 0),
     "tls_proof_handle_message"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PROOF_HANDLE_MESSAGE_RESPONSE, 0),
     "tls_proof_handle_message_response"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_VERIFY_CERT_CHAIN_FROM_PROOF, 0),
     "verify_cert_chain_from_proof"},
...
static const ERR_STRING_DATA SSL_str_reasons[] = {
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_ALL_RECORDS_ARE_HIDDEN),
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_CERT_CHAIN_NOT_VERIFIED),
    "cert chain not verified"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_CERT_LENGTH_MISMATCH),
    "cert length mismatch"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_CHECK_PERFORMED), "check performed"},
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_CONVERSATION_OUTSIDE_TIME_CONSTRAINTS),
    "conversation outside time constraints"},
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_COULD_NOT_RETRIEVE_PROOF),
    "could not retrieve proof"},
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_EXTENSION_NOT_NEGOTIATED),
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_FOUND_UNEXPECTED_CERTIFICATE_CHAIN),
    "found unexpected certificate chain"},
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_INCORRECT_NEGOTIATION_PARAMETERS),
    "incorrect negotiation parameters"},
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_INVALID_CERT_CHAIN), "invalid cert chain"},
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_INVALID_EVIDENCE), "invalid evidence"},
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_INVALID_MESSAGE), "invalid message"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_INVALID_NEGATIVE_NUMBER),
    "invalid negative number"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_INVALID_NULL_CMD_NAME),
    "invalid null cmd name"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_INVALID_OPTION), "invalid option"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_INVALID_ORDERING_VECTOR),
    "invalid ordering vector"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_INVALID_POSITION_FOR_NEGATIVE_NUMBER),
    "invalid position for negative number"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_INVALID_PROOF), "invalid proof"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_INVALID_PROOF_SIZE), "invalid proof size"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_INVALID_RESPONSE), "invalid response"},
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_NO_CERTIFICATE_CHAIN_FOUND),
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_NO_MESSAGE_EXCHANGED),
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_PROOF_DOES_NOT_MATCH_SIGNATURE),
    "proof does not match signature"},
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_RECEIVED_NON_TLSN_MESSAGE),
    "received non tlsn message"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_RECEIVED_NON_TLS_PROOF_MESSAGE),
    "received non tls proof message"},
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_REPEATED_ELEMENT_IN_SENSITIVE_MATRIX),
    "repeated element in sensitive matrix"},
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_SALT_OR_CHUNK_SIZE_NOT_CORRECTLY_NEGOTIATED),
    "salt or chunk size not correctly negotiated"},
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_SENSITIVE_MATRIX_ELEMENT_GREATER_THEN_RECORDS_CHUNKS_NUMBER),
    "sensitive matrix element greater then records chunks number"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_SENSITIVE_MATRIX_HAS_),
    "sensitive matrix has "},
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_WRONG_ROWS_NUMBER), "wrong rows number"},
