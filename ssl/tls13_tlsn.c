...
typedef struct hidden_plaintext_proof_node_str {
    ...
    uint16_t num_salts;
    uint16_t num_hashes;
    uint8_t gen_orig;           /* Is the record sent by the generator? */
...
/*It tells you the location of a salt in the salt tree. Note: in this structure, data are saved in network bte order */
